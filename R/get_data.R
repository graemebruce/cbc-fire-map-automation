...
for (i in agencies) {
  ...
  sf::st_write(out_of_control_locations, dsn = paste0("clean_map_data/locations/",i,"/out_of_control_locations.geojson"), layer = paste0("clean_map_data/locations/",i,"/out_of_c
